...
public class AufbauService extends NamedItemServiceImpl<AufbauModel, AufbauRequest,  Aufbau> {
    ...
    @Autowired
    public AufbauService(AufbauRepository repository, AufbauRequestMapper requestMapper, AufbauMapper entityMapper, FileService fileService, AufbauLookup lookup) {
