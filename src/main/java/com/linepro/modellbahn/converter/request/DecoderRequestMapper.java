...
public class DecoderRequestMapper extends MapperImpl<DecoderRequest, Decoder> {
    ...
    @Autowired
    public DecoderRequestMapper(DecoderTypLookup typLookup, ProtokollLookup protokollLookup) {
        super(() -> new Decoder(), new DecoderRequestTranscriber(typLookup, protokollLookup));
    }
}
