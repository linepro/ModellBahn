...
@Lazy
@Component("KategorieModelProcessor")
public class KategorieModelProcessor extends NamedModelProcessor<KategorieModel> implements RepresentationModelProcessor<KategorieModel> {
    ...
    public KategorieModelProcessor() {
        super(
            ApiPaths.ADD_KATEGORIE, 
            ApiPaths.GET_KATEGORIE, 
            ApiPaths.UPDATE_KATEGORIE, 
            ApiPaths.DELETE_KATEGORIE, 
            ApiPaths.SEARCH_KATEGORIE,
            new LinkTemplateImpl(ApiRels.ADD, ApiPaths.ADD_UNTER_KATEGORIE, EXTRACTOR)
            );
    }
}
