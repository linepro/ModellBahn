...
import static com.linepro.modellbahn.controller.impl.ApiPaths.ADD_EPOCH_ABBILDUNG;
...
public class EpochModelProcessor extends NamedModelProcessor<EpochModel> implements RepresentationModelProcessor<EpochModel> {
    ...
    public EpochModelProcessor() {
        super(ADD_EPOCH, GET_EPOCH, UPDATE_EPOCH, DELETE_EPOCH, SEARCH_EPOCH, new LinkTemplateImpl(ABBILDUNG, ADD_EPOCH_ABBILDUNG, EXTRACTOR));
    }
}
