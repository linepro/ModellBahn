...
public class KupplungRequest implements NamedItemRequest {

    /**
     * 
     */
    private static final long serialVersionUID = -5608683764888277005L;
    ...
    public boolean equals(Object obj) {
        ...
        if (!(obj instanceof KupplungRequest)) {
            return false; 
        }

        KupplungRequest other = (KupplungRequest) obj;
