...
public class DecoderTypAdressRequest implements ItemRequest {

    /**
     * 
     */
    private static final long serialVersionUID = -3337028771343867248L;
    ...
    public boolean equals(Object obj) {
        ...
        if (!(obj instanceof DecoderTypAdressRequest)) {
            return false; 
        }

        DecoderTypAdressRequest other = (DecoderTypAdressRequest) obj;
