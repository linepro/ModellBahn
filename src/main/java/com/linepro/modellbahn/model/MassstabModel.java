...
public class MassstabModel extends SpringdocModel<MassstabModel> implements NamedItemModel, Comparable<MassstabModel> {
    ...
    @Schema(name = ApiNames.MASSSTAB + "Page")
    public static class PagedMassstabModel extends PagedSchema<MassstabModel>{}
}