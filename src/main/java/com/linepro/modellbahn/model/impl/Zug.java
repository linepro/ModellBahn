...
public class Zug extends AbstractNamedItem<Zug> implements IZug {
    ...
    public String toString() {
        return new ToStringBuilder(this).appendSuper(super.toString()).append(ApiNames.ZUG_TYP, getZugTyp())
                .append(ApiNames.CONSIST, getConsist()).toString();
    }
}
