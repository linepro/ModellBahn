...
public class ZugModel extends NamedItemModelImpl<ZugModel> {
    ...
    @ApiModelProperty(dataType = "com.linepro.modellbahn.model.ZugTypModel", value = "Train type", required = true)
    private ZugTypModel zugTyp;

    @JsonProperty(ApiNames.CONSIST)
    @JsonView(Views.Public.class)
    @ApiModelProperty(dataType = "[Lcom.linepro.modellbahn.model.IZugConsistRef;", value = "Train composition", access = "READ_ONLY")
