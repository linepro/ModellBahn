...
public class SteuerungController extends AbstractNamedItemController<SteuerungModel,Steuerung> {
    ...
    @ApiOperation(value = "Finds a Steuerung by name", response = SteuerungModel.class)
    ...
    @ApiOperation(value = "Finds Steuerungen by example", response = SteuerungModel.class, responseContainer = "List")
    @ApiImplicitParams({
    ...
    @JsonView(Views.Public.class)
    @ApiOperation(code = 201, value = "Adds a Steuerung", response = SteuerungModel.class)
    public ResponseEntity<?> add(SteuerungModel model) {
    ...
    @JsonView(Views.Public.class)
    @ApiOperation(code = 202, value = "Updates a Steuerung by name", response = SteuerungModel.class)
    public ResponseEntity<?> update(@PathVariable(ApiPaths.NAME_PARAM_NAME) String name, SteuerungModel model) {
