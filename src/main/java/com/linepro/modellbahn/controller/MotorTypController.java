...
public class MotorTypController extends AbstractNamedItemController<MotorTypModel,MotorTyp> {
    ...
    @ApiOperation(value = "Finds a MotorTyp by name", response = MotorTypModel.class)
    ...
    @ApiOperation(value = "Finds MotorTypen by example", response = MotorTypModel.class, responseContainer = "List")
    @ApiImplicitParams({
    ...
    @JsonView(Views.Public.class)
    @ApiOperation(code = 201, value = "Adds a MotorTyp", response = MotorTypModel.class)
    public ResponseEntity<?> add(MotorTypModel model) {
    ...
    @JsonView(Views.Public.class)
    @ApiOperation(code = 202, value = "Updates a MotorTyp by name", response = MotorTypModel.class)
    public ResponseEntity<?> update(@PathVariable(ApiPaths.NAME_PARAM_NAME) String name, MotorTypModel model) {
