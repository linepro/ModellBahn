...
public class MotorTypController extends NamedItemController<MotorTypModel> {
    ...
    public ResponseEntity<?> search(@RequestBody MotorTypModel model, @RequestParam(name = ApiNames.PAGE_NUMBER, required = false) Integer pageNumber, @RequestParam(name = ApiNames.PAGE_SIZE, required = false) Integer pageSize) {
    ...
    public ResponseEntity<?> update(@PathVariable(ApiPaths.NAME_PARAM_NAME) String name, @RequestBody MotorTypModel model) {
