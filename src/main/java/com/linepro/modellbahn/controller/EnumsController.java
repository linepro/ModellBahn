...
public class EnumsController {
    ...
    @GetMapping(path = ApiPaths.ENUMS_ADRESS_TYP_PATH, produces = { MediaType.APPLICATION_JSON_VALUE, MediaTypes.HAL_JSON_VALUE })
    ...
    @GetMapping(path = ApiPaths.ENUMS_ANDERUNGS_TYP_PATH, produces = { MediaType.APPLICATION_JSON_VALUE, MediaTypes.HAL_JSON_VALUE })
    ...
    @GetMapping(path = ApiPaths.ENUMS_DECODER_STATUS_PATH, produces = { MediaType.APPLICATION_JSON_VALUE, MediaTypes.HAL_JSON_VALUE })
    ...
    @GetMapping(path = ApiPaths.ENUMS_KONFIGURATION_PATH, produces = { MediaType.APPLICATION_JSON_VALUE, MediaTypes.HAL_JSON_VALUE })
    ...
    @GetMapping(path = ApiPaths.ENUMS_LAND_PATH, produces = { MediaType.APPLICATION_JSON_VALUE, MediaTypes.HAL_JSON_VALUE })
    ...
    @GetMapping(path = ApiPaths.ENUMS_LEISTUNGSUBERTRAGUNG_PATH, produces = { MediaType.APPLICATION_JSON_VALUE, MediaTypes.HAL_JSON_VALUE })
    ...
    @GetMapping(path = ApiPaths.ENUMS_STATUS_PATH, produces = { MediaType.APPLICATION_JSON_VALUE, MediaTypes.HAL_JSON_VALUE })
    ...
    @GetMapping(path = ApiPaths.ENUMS_STECKER_PATH, produces = { MediaType.APPLICATION_JSON_VALUE, MediaTypes.HAL_JSON_VALUE })
    ...
    @GetMapping(path = ApiPaths.ENUMS_WAHRUNG_PATH, produces = { MediaType.APPLICATION_JSON_VALUE, MediaTypes.HAL_JSON_VALUE })
