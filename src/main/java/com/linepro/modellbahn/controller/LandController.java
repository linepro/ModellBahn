...
public class LandController extends AbstractNamedItemController<LandModel,Land> {
    ...
    public static LandModel create() {
        return new LandModel();
    }

    @GetMapping(ApiPaths.NAME_PART)
    @JsonView(Views.Public.class)
    @ApiOperation(value = "Finds a Land by name", response = LandModel.class)
    ...
    @ApiOperation(value = "Finds Landen by example", response = LandModel.class, responseContainer = "List")
    @ApiImplicitParams({
    ...
    @JsonView(Views.Public.class)
    @ApiOperation(code = 201, value = "Adds a Land", response = LandModel.class)
    public ResponseEntity<?> add(LandModel model) {
    ...
    @JsonView(Views.Public.class)
    @ApiOperation(code = 202, value = "Updates a Land by name", response = LandModel.class)
    public ResponseEntity<?> update(@PathVariable(ApiPaths.NAME_PARAM_NAME) String name, LandModel model) {
