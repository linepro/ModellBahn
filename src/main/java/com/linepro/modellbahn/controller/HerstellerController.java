...
public class HerstellerController extends AbstractNamedItemController<HerstellerModel,Hersteller> {
    ...
    @ApiOperation(value = "Finds a Hersteller by name", response = HerstellerModel.class)
    ...
    @ApiOperation(value = "Finds Herstelleren by example", response = HerstellerModel.class, responseContainer = "List")
    @ApiImplicitParams({
    ...
    @JsonView(Views.Public.class)
    @ApiOperation(code = 201, value = "Adds a Hersteller", response = HerstellerModel.class)
    public ResponseEntity<?> add(HerstellerModel model) {
        return super.add(model);
    }

    @PutMapping(ApiPaths.NAME_PART)
    @JsonView(Views.Public.class)
    @ApiOperation(code = 202, value = "Updates a Hersteller by name", response = HerstellerModel.class)
    public ResponseEntity<?> update(@PathVariable(ApiPaths.NAME_PARAM_NAME) String name, HerstellerModel model) {
