...
public class HerstellerController extends NamedItemController<HerstellerModel> {
    ...
    public ResponseEntity<?> search(@RequestBody HerstellerModel model, @RequestParam(name = ApiNames.PAGE_NUMBER, required = false) Integer pageNumber, @RequestParam(name = ApiNames.PAGE_SIZE, required = false) Integer pageSize) {
    ...
    public ResponseEntity<?> update(@PathVariable(ApiPaths.NAME_PARAM_NAME) String name, @RequestBody HerstellerModel model) {
