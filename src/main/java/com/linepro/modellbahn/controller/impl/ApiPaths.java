...
public interface ApiPaths {
    ...
    String ADD_PRODUKT_DECODER_TYP            = PRODUKT_ROOT + "/{" + ApiNames.HERSTELLER + ":" + DBNames.NAME_PATTERN + "}/{" + ApiNames.BESTELL_NR + ":" + DBNames.NAME_PATTERN + "}/" + ApiNames.DECODER_TYP + "/{" + ApiNames.TYP_HERSTELLER + ":" + DBNames.NAME_PATTERN + "}/{" + ApiNames.TYP_BESTELL_NR + ":" + DBNames.NAME_PATTERN + "}";
    String DELETE_PRODUKT_DECODER_TYP         = PRODUKT_ROOT + "/{" + ApiNames.HERSTELLER + ":" + DBNames.NAME_PATTERN + "}/{" + ApiNames.BESTELL_NR + ":" + DBNames.NAME_PATTERN + "}/" + ApiNames.DECODER_TYP + "/{" + ApiNames.TYP_HERSTELLER + ":" + DBNames.NAME_PATTERN + "}/{" + ApiNames.TYP_BESTELL_NR + ":" + DBNames.NAME_PATTERN + "}";
    ...
    String ADD_SONDERMODELL_ABBILDUNG    = SONDERMODELL_ROOT + "/{" + ApiNames.NAMEN + ":" + DBNames.NAME_PATTERN + "}/" + ApiNames.ABBILDUNG;
    String DELETE_SONDERMODELL_ABBILDUNG = SONDERMODELL_ROOT + "/{" + ApiNames.NAMEN + ":" + DBNames.NAME_PATTERN + "}/" + ApiNames.ABBILDUNG;
