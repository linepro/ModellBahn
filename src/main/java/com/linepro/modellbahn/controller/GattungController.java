...
@RestController
@RequestMapping(ApiPaths.GATTUNG)
public class GattungController extends AbstractNamedItemController<GattungModel,Gattung> {
    ...
    @ApiOperation(value = "Finds a Gattung by name", response = GattungModel.class)
    ...
    @ApiOperation(value = "Finds Gattungen by example", response = GattungModel.class, responseContainer = "List")
    @ApiImplicitParams({
    ...
    @JsonView(Views.Public.class)
    @ApiOperation(code = 201, value = "Adds a Gattung", response = GattungModel.class)
    public ResponseEntity<?> add(GattungModel model) {
    ...
    @JsonView(Views.Public.class)
    @ApiOperation(code = 202, value = "Updates a Gattung by name", response = GattungModel.class)
    public ResponseEntity<?> update(@PathVariable(ApiPaths.NAME_PARAM_NAME) String name, GattungModel model) {
