...
public class GattungController extends NamedItemController<GattungModel> {
    ...
    public ResponseEntity<?> search(@RequestBody GattungModel model, @RequestParam(name = ApiNames.PAGE_NUMBER, required = false) Integer pageNumber, @RequestParam(name = ApiNames.PAGE_SIZE, required = false) Integer pageSize) {
    ...
    public ResponseEntity<?> update(@PathVariable(ApiPaths.NAME_PARAM_NAME) String name, @RequestBody GattungModel model) {
