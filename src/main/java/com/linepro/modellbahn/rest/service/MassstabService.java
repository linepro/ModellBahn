...
public class MassstabService extends AbstractItemService<NameKey, Massstab> {
    ...
    @Produces(MediaType.APPLICATION_JSON)
    @JsonView(Views.Public.class)
    @ApiOperation(value = "Adds a Massstab", response = Massstab.class)
    ...
    @Produces(MediaType.APPLICATION_JSON)
    @JsonView(Views.Public.class)
    @ApiOperation(value = "Updates a Massstab by name", response = Massstab.class)
    ...
    @Produces(MediaType.APPLICATION_JSON)
    @JsonView(Views.Public.class)
    @ApiOperation(value = "Deletes a Massstab by name")
