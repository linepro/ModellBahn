...
public class DecoderTypService extends AbstractItemService<String, DecoderTyp> {
    ...
    @Produces(MediaType.APPLICATION_JSON)
    @JsonView(Views.Public.class)
    public Response update(@PathParam(ApiPaths.NAME_PARAM_NAME) String name, DecoderTyp entity) {
