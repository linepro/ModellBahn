...
public class GattungService extends AbstractNamedItemService<IGattung, Gattung> {

    @Autowired
    public GattungService(IGattungRepository persister) {
        super(persister);
    }

    @JsonCreator(mode = Mode.DELEGATING)
    public static IGattung create() {
        return new Gattung();
    }
    ...
    public ResponseEntity<?> add(IGattung entity) {
    ...
    public ResponseEntity<?> update(@PathVariable(ApiPaths.NAME_PARAM_NAME) String name, IGattung entity) {
