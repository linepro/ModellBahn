...
public class SpurweiteService extends AbstractNamedItemService<ISpurweite,Spurweite> {

    @Autowired
    public SpurweiteService(ISpurweiteRepository persister) {
        super(persister);
    }

    @JsonCreator(mode= Mode.DELEGATING)
    public static ISpurweite create() {
    ...
    public  ResponseEntity<?> add(ISpurweite entity) {
    ...
    public  ResponseEntity<?> update(@PathVariable(ApiPaths.NAME_PARAM_NAME) String name, ISpurweite entity) {
