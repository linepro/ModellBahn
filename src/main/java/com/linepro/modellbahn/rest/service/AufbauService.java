...
public class AufbauService extends AbstractItemService<NameKey, Aufbau> {
    ...
    @ApiImplicitParams({
        @ApiImplicitParam( name = ApiNames.ID, value = "Aufbau's id", required = false, dataType = "Long", paramType = "query"),
        @ApiImplicitParam( name = ApiNames.NAMEN, value = "Aufbau's name", required = false, dataType = "String", paramType = "query"),
        @ApiImplicitParam( name = ApiNames.BEZEICHNUNG, value = "Aufbau's description", required = false, dataType = "String", paramType = "query"),
        @ApiImplicitParam( name = ApiNames.DELETED, value = "true if Aufbau is deleted", required = false, dataType = "Boolean", paramType = "query")
})
