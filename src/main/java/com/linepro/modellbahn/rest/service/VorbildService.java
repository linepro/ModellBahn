...
public class VorbildService extends AbstractItemService<VorbildKey, Vorbild> {
    ...
    public Vorbild create(@JsonProperty(value = ApiNames.ID) Long id,
            ...
            @JsonProperty(value = ApiNames.LEISTUNGSUEBERTRAGUNG) LeistungsUbertragung leistungsUbertragung,
    ...
    @ApiImplicitParams({
        @ApiImplicitParam( name = ApiNames.ID, value = "Vorbild's id", dataType = "Long", paramType = "query"),
        @ApiImplicitParam( name = ApiNames.GATTUNG, value = "", dataType = "String", paramType = "query"),
        @ApiImplicitParam( name =  ApiNames.UNTER_KATEGORIE, value = "", dataType = "String", paramType = "query"),
        @ApiImplicitParam( name =  ApiNames.BAHNVERWALTUNG, value = "", dataType = "String", paramType = "query"),
        @ApiImplicitParam( name =  ApiNames.HERSTELLER, value = "", dataType = "String", paramType = "query"),
        @ApiImplicitParam( name =  ApiNames.BAUZEIT, value = "", dataType = "String", paramType = "query"),
        @ApiImplicitParam( name =  ApiNames.ANZAHL, value = "", dataType = "String", paramType = "query"),
        @ApiImplicitParam( name =  ApiNames.BETREIBSNUMMER, value = "", dataType = "String", paramType = "query"),
        @ApiImplicitParam( name =  ApiNames.ANTRIEB, value = "", dataType = "String", paramType = "query"),
        @ApiImplicitParam( name =  ApiNames.ACHSFOLG, value = "", dataType = "String", paramType = "query"),
        @ApiImplicitParam( name =  ApiNames.ANFAHRZUGKRAFT, value = "", dataType = "String", paramType = "query"),
        @ApiImplicitParam( name =  ApiNames.LEISTUNG, value = "", dataType = "String", paramType = "query"),
        @ApiImplicitParam( name =  ApiNames.DIENSTGEWICHT, value = "", dataType = "String", paramType = "query"),
        @ApiImplicitParam( name =  ApiNames.GESCHWINDIGKEIT, value = "", dataType = "String", paramType = "query"),
        @ApiImplicitParam( name =  ApiNames.LANGE, value = "", dataType = "String", paramType = "query"),
        @ApiImplicitParam( name =  ApiNames.AUSSERDIENST, value = "", dataType = "String", paramType = "query"),
        @ApiImplicitParam( name =  ApiNames.DMTREIBRAD, value = "", dataType = "String", paramType = "query"),
        @ApiImplicitParam( name =  ApiNames.DMLAUFRADVORN, value = "", dataType = "String", paramType = "query"),
        @ApiImplicitParam( name =  ApiNames.DMLAUFRADHINTEN, value = "", dataType = "String", paramType = "query"),
        @ApiImplicitParam( name =  ApiNames.ZYLINDER, value = "", dataType = "String", paramType = "query"),
        @ApiImplicitParam( name =  ApiNames.DMZYLINDER, value = "", dataType = "String", paramType = "query"),
        @ApiImplicitParam( name =  ApiNames.KOLBENHUB, value = "", dataType = "String", paramType = "query"),
        @ApiImplicitParam( name =  ApiNames.KESSELUEBERDRUCK, value = "", dataType = "String", paramType = "query"),
        @ApiImplicitParam( name =  ApiNames.ROSTFLAECHE, value = "", dataType = "String", paramType = "query"),
        @ApiImplicitParam( name =  ApiNames.UEBERHITZERFLAECHE, value = "", dataType = "String", paramType = "query"),
        @ApiImplicitParam( name =  ApiNames.WASSERVORRAT, value = "", dataType = "String", paramType = "query"),
        @ApiImplicitParam( name =  ApiNames.VERDAMPFUNG, value = "", dataType = "String", paramType = "query"),
        @ApiImplicitParam( name =  ApiNames.STEUERUNG, value = "", dataType = "String", paramType = "query"),
        @ApiImplicitParam( name =  ApiNames.FAHRMOTOREN, value = "", dataType = "String", paramType = "query"),
        @ApiImplicitParam( name =  ApiNames.MOTORBAUART, value = "", dataType = "String", paramType = "query"),
        @ApiImplicitParam( name =  ApiNames.LEISTUNGSUEBERTRAGUNG, value = "", dataType = "String", paramType = "query"),
        @ApiImplicitParam( name =  ApiNames.REICHWEITE, value = "", dataType = "String", paramType = "query"),
        @ApiImplicitParam( name =  ApiNames.KAPAZITAT, value = "", dataType = "String", paramType = "query"),
        @ApiImplicitParam( name =  ApiNames.KLASSE, value = "", dataType = "String", paramType = "query"),
        @ApiImplicitParam( name =  ApiNames.SITZPLATZEKL1, value = "", dataType = "String", paramType = "query"),
        @ApiImplicitParam( name =  ApiNames.SITZPLATZEKL2, value = "", dataType = "String", paramType = "query"),
        @ApiImplicitParam( name =  ApiNames.SITZPLATZEKL3, value = "", dataType = "String", paramType = "query"),
        @ApiImplicitParam( name =  ApiNames.SITZPLATZEKL4, value = "", dataType = "String", paramType = "query"),
        @ApiImplicitParam( name =  ApiNames.AUFBAU, value = "", dataType = "String", paramType = "query"),
