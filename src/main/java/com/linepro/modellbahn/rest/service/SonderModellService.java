...
public class SonderModellService extends AbstractItemService<NameKey, SonderModell> {
    ...
    @ApiImplicitParams({
        @ApiImplicitParam( name = ApiNames.ID, value = "SonderModell's id", dataType = "Long", paramType = "query"),
        @ApiImplicitParam( name = ApiNames.NAMEN, value = "SonderModell's name", dataType = "String", paramType = "query"),
        @ApiImplicitParam( name = ApiNames.BEZEICHNUNG, value = "SonderModell's description", dataType = "String", paramType = "query"),
        @ApiImplicitParam( name = ApiNames.DELETED, value = "if true include deleted SonderModell ", dataType = "Boolean", paramType = "query"),
