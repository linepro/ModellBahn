...
public interface ApiPaths {
    ...
    public static final String LOG_PREFIX = "%s: %s";
    ...
    String DECODER_LOG         = LOG_PREFIX + SEPARATOR;
    ...
    String PRODUKT_LOG = LOG_PREFIX + SEPARATOR + "%s";
    ...
    String UNTER_KATEGORIE_ROOT_LOG = LOG_PREFIX + SEPARATOR + ApiNames.UNTER_KATEGORIEN;
    ...
    String VORBILD_ABBILDUNG_LOG = LOG_PREFIX + SEPARATOR + ApiNames.ABBILDUNG;

    String ZUG_CONSIST_ROOT = ZUG_PART + SEPARATOR + ApiNames.CONSIST;
    String ZUG_CONSIST_ROOT_LOG = LOG_PREFIX + SEPARATOR + ApiNames.CONSIST;
