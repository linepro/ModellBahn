...
public interface ApiPaths {
    ...
    String ARTIKEL_ABBILDUNG = FIELD_START + ARTIKEL_ID_PARAM_NAME + NOT_NULL_REGEX + FIELD_END + SEPARATOR + ApiNames.ABBILDUNG;
    ...
    String VORBILD_ABBILDUNG_PART = FIELD_START + NAME_PARAM_NAME + NOT_NULL_REGEX + FIELD_END + SEPARATOR + ApiNames.ABBILDUNG;
