...
CREATE INDEX IF NOT EXISTS DECODER_ADRESS_IX1 ON DECODER_ADRESS (DECODER_ID ASC);
CREATE INDEX IF NOT EXISTS DECODER_ADRESS_IX2 ON DECODER_ADRESS (ADRESS_ID ASC);
...
CREATE INDEX IF NOT EXISTS DECODER_TYP_ADRESS_IX1 ON DECODER_TYP_ADRESS (DECODER_TYP_ID ASC);
CREATE INDEX IF NOT EXISTS DECODER_TYP_ADRESS_IX2 ON DECODER_TYP_ADRESS (POSITION ASC);
...
ALTER TABLE IF EXISTS DECODER_ADRESS ADD CONSTRAINT IF NOT EXISTS DECODER_ADRESS_UC1 UNIQUE (DECODER_ID ASC, ADRESS_ID ASC);
...
ALTER TABLE IF EXISTS DECODER_TYP_ADRESS ADD CONSTRAINT IF NOT EXISTS DECODER_TYP_ADRESS_UC1 UNIQUE (DECODER_TYP_ID ASC, POSITION ASC);

ALTER TABLE IF EXISTS DECODER_TYP_CV ADD CONSTRAINT IF NOT EXISTS DECODER_TYP_CV_UC1 UNIQUE (DECODER_TYP_ID ASC, CV ASC);

ALTER TABLE IF EXISTS DECODER_TYP_FUNKTION ADD CONSTRAINT IF NOT EXISTS DECODER_TYP_FUNKTION_UC1 UNIQUE (DECODER_TYP_ID ASC, REIHE ASC, FUNKTION ASC);
...
ALTER TABLE IF EXISTS DECODER ADD CONSTRAINT IF NOT EXISTS DECODER_FK3 FOREIGN KEY (ARTIKEL_ID) REFERENCES ARTIKEL (ID) ON DELETE RESTRICT ON UPDATE RESTRICT;
...
ALTER TABLE IF EXISTS DECODER_TYP_ADRESS ADD CONSTRAINT IF NOT EXISTS DECODER_TYP_ADRESS_FK1 FOREIGN KEY (DECODER_TYP_ID) REFERENCES DECODER_TYP (ID) ON DELETE RESTRICT ON UPDATE RESTRICT;
