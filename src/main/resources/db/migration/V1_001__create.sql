...
CREATE TABLE IF NOT EXISTS PRODUKT_DECODER_TYP (
        PRODUKT_ID BIGINT NOT NULL,
        DECODER_TYP_ID BIGINT NOT NULL,
        DELETED BOOLEAN NOT NULL
    );
...
CREATE INDEX IF NOT EXISTS PRODUKT_DECODER_TYP_IX1 ON PRODUKT_DECODER_TYP (PRODUKT_ID ASC);
CREATE INDEX IF NOT EXISTS PRODUKT_DECODER_TYP_IX2 ON PRODUKT_DECODER_TYP (DECODER_TYP_ID ASC);
...
CREATE INDEX IF NOT EXISTS PRODUKT_IX15 ON PRODUKT (MOTOR_TYP_ID ASC);
...
ALTER TABLE IF EXISTS PRODUKT_DECODER_TYP ADD CONSTRAINT IF NOT EXISTS PRODUKT_DECODER_TYP_UC1 UNIQUE (PRODUKT_ID ASC, DECODER_TYP_ID ASC);
...
ALTER TABLE IF EXISTS PRODUKT ADD CONSTRAINT IF NOT EXISTS PRODUKT_FK1 FOREIGN KEY (HERSTELLER_ID) REFERENCES HERSTELLER (ID) ON DELETE RESTRICT ON UPDATE RESTRICT;
ALTER TABLE IF EXISTS PRODUKT ADD CONSTRAINT IF NOT EXISTS PRODUKT_FK2 FOREIGN KEY (EPOCH_ID) REFERENCES EPOCH (ID) ON DELETE RESTRICT ON UPDATE RESTRICT;
ALTER TABLE IF EXISTS PRODUKT ADD CONSTRAINT IF NOT EXISTS PRODUKT_FK3 FOREIGN KEY (GATTUNG_ID) REFERENCES GATTUNG (ID) ON DELETE RESTRICT ON UPDATE RESTRICT;
ALTER TABLE IF EXISTS PRODUKT ADD CONSTRAINT IF NOT EXISTS PRODUKT_FK4 FOREIGN KEY (BAHNVERWALTUNG_ID) REFERENCES BAHNVERWALTUNG (ID) ON DELETE RESTRICT ON UPDATE RESTRICT;
ALTER TABLE IF EXISTS PRODUKT ADD CONSTRAINT IF NOT EXISTS PRODUKT_FK5 FOREIGN KEY (ACHSFOLG_ID) REFERENCES ACHSFOLG (ID) ON DELETE RESTRICT ON UPDATE RESTRICT;
ALTER TABLE IF EXISTS PRODUKT ADD CONSTRAINT IF NOT EXISTS PRODUKT_FK6 FOREIGN KEY (MASSSTAB_ID) REFERENCES MASSSTAB (ID) ON DELETE RESTRICT ON UPDATE RESTRICT;
ALTER TABLE IF EXISTS PRODUKT ADD CONSTRAINT IF NOT EXISTS PRODUKT_FK7 FOREIGN KEY (SPURWEITE_ID) REFERENCES SPURWEITE (ID) ON DELETE RESTRICT ON UPDATE RESTRICT;
ALTER TABLE IF EXISTS PRODUKT ADD CONSTRAINT IF NOT EXISTS PRODUKT_FK8 FOREIGN KEY (UNTER_KATEGORIE_ID) REFERENCES UNTER_KATEGORIE (ID) ON DELETE RESTRICT ON UPDATE RESTRICT;
ALTER TABLE IF EXISTS PRODUKT ADD CONSTRAINT IF NOT EXISTS PRODUKT_FK9 FOREIGN KEY (SONDERMODELL_ID) REFERENCES SONDERMODELL (ID) ON DELETE RESTRICT ON UPDATE RESTRICT;
ALTER TABLE IF EXISTS PRODUKT ADD CONSTRAINT IF NOT EXISTS PRODUKT_FK10 FOREIGN KEY (AUFBAU_ID) REFERENCES AUFBAU (ID) ON DELETE RESTRICT ON UPDATE RESTRICT;
ALTER TABLE IF EXISTS PRODUKT ADD CONSTRAINT IF NOT EXISTS PRODUKT_FK11 FOREIGN KEY (LICHT_ID) REFERENCES LICHT (ID) ON DELETE RESTRICT ON UPDATE RESTRICT;
ALTER TABLE IF EXISTS PRODUKT ADD CONSTRAINT IF NOT EXISTS PRODUKT_FK12 FOREIGN KEY (KUPPLUNG_ID) REFERENCES KUPPLUNG (ID) ON DELETE RESTRICT ON UPDATE RESTRICT;
ALTER TABLE IF EXISTS PRODUKT ADD CONSTRAINT IF NOT EXISTS PRODUKT_FK13 FOREIGN KEY (VORBILD_ID) REFERENCES VORBILD (ID) ON DELETE RESTRICT ON UPDATE RESTRICT;
ALTER TABLE IF EXISTS PRODUKT ADD CONSTRAINT IF NOT EXISTS PRODUKT_FK14 FOREIGN KEY (STEUERUNG_ID) REFERENCES STEUERUNG (ID) ON DELETE RESTRICT ON UPDATE RESTRICT;
...
ALTER TABLE IF EXISTS PRODUKT_DECODER_TYP ADD CONSTRAINT IF NOT EXISTS PRODUKT_DECODER_TYP_FK1 FOREIGN KEY (PRODUKT_ID) REFERENCES PRODUKT (ID) ON DELETE RESTRICT ON UPDATE RESTRICT;
ALTER TABLE IF EXISTS PRODUKT_DECODER_TYP ADD CONSTRAINT IF NOT EXISTS PRODUKT_DECODER_TYP_FK2 FOREIGN KEY (DECODER_TYP_ID) REFERENCES DECODER_TYP (ID) ON DELETE RESTRICT ON UPDATE RESTRICT;
