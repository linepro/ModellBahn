...
CREATE INDEX IF NOT EXISTS DECODERADRESS_FK1 ON DECODER_ADRESS (DECODER_ID ASC);
CREATE INDEX IF NOT EXISTS DECODERADRESS_FK2 ON DECODER_ADRESS (ADRESS_ID ASC);

CREATE INDEX IF NOT EXISTS DECODERCV_FK1 ON DECODER_CV (DECODER_ID ASC);
CREATE INDEX IF NOT EXISTS DECODERCV_FK2 ON DECODER_CV (CV_ID ASC);

CREATE INDEX IF NOT EXISTS DECODERFUNKTION_FK1 ON DECODER_FUNKTION (DECODER_ID ASC);
CREATE INDEX IF NOT EXISTS DECODERFUNKTION_FK2 ON DECODER_FUNKTION (FUNKTION_ID ASC);
...
CREATE INDEX IF NOT EXISTS VORBILD_FK3 ON VORBILD (BAHNVERWALTUNG_ID ASC);
...
ALTER TABLE IF EXISTS DECODER_ADRESS ADD CONSTRAINT IF NOT EXISTS DECODERADRESS_UC1 UNIQUE (DECODER_ID ASC, ADRESS_ID ASC);
...
ALTER TABLE IF EXISTS DECODER_CV ADD CONSTRAINT IF NOT EXISTS DECODERCV_UC1 UNIQUE (DECODER_ID ASC, CV_ID ASC);
...
ALTER TABLE IF EXISTS DECODER_FUNKTION ADD CONSTRAINT IF NOT EXISTS DECODERFUNKTION_UC1 UNIQUE (DECODER_ID ASC, FUNKTION_ID ASC);
...
ALTER TABLE IF EXISTS DECODER_TYP ADD CONSTRAINT IF NOT EXISTS DECODERTYP_UC1 UNIQUE (HERSTELLER_ID ASC, BESTELL_NR ASC);
...
ALTER TABLE IF EXISTS DECODER_TYP_ADRESS ADD CONSTRAINT IF NOT EXISTS DECODERTYPADRESS_UC1 UNIQUE (DECODER_TYP_ID ASC, POSITION ASC);
...
ALTER TABLE IF EXISTS DECODER_TYP_CV ADD CONSTRAINT IF NOT EXISTS DECODERTYPCV_UC1 UNIQUE (DECODER_TYP_ID ASC, CV ASC);
...
ALTER TABLE IF EXISTS DECODER_TYP_FUNKTION ADD CONSTRAINT IF NOT EXISTS DECODERTYPFUNKTION_UC1 UNIQUE (DECODER_TYP_ID ASC, REIHE ASC, FUNKTION ASC);
...
ALTER TABLE IF EXISTS PRODUKT_TEIL ADD CONSTRAINT IF NOT EXISTS PRODUKTTEIL_UC1 UNIQUE (PRODUKT_ID ASC, TEIL_ID ASC);
...
ALTER TABLE IF EXISTS UNTER_KATEGORIE ADD CONSTRAINT IF NOT EXISTS UNTERKATEGORIE_UC1 UNIQUE (KATEGORIE_ID ASC, NAME ASC);
...
ALTER TABLE IF EXISTS VORBILD ADD CONSTRAINT IF NOT EXISTS VORBILD_UC1 UNIQUE (GATTUNG_ID ASC);
...
ALTER TABLE IF EXISTS ZUG_CONSIST ADD CONSTRAINT IF NOT EXISTS ZUGCONSIST_UC1 UNIQUE (ZUG_ID ASC, POSITION ASC);

ALTER TABLE IF EXISTS ZUG_TYP ADD CONSTRAINT IF NOT EXISTS ZUGTYP_UC1 UNIQUE (NAME ASC);