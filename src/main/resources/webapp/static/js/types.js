...
const ACHSFOLG = new DropDownColumn('Achsfolg', 'achsfolg', (entity) => { return entity.achsfolg ? entity.achsfolg.name : undefined; }, (entity, value) => { entity.achsfolg = { name: value }; }, ACHSFOLG_DROP, Editable.UPDATE, false, 30, 5);
...
const ANTRIEB = new DropDownColumn('Antrieb', 'antrieb', (entity) => { return entity.antrieb ? entity.antrieb.name : undefined; }, (entity, value) => { entity.antrieb = { name: value }; }, ANTRIEB_DROP, Editable.UPDATE, false, 30, 5);
...
const ARTIKEL = new DropDownColumn('Artikel', 'artikel', (entity) => { return entity.artikel ? entity.artikel.artikelId : undefined; }, (entity, value) => { entity.artikel = { artikelId: value }; }, ARTIKEL_DROP, Editable.UPDATE, false, 50, 5);
...
const AUFBAU = new DropDownColumn('Aufbau', 'aufbau', (entity) => { return entity.aufbau ? entity.aufbau.name : undefined; }, (entity, value) => { entity.aufbau = { name: value }; }, AUFBAU_DROP, Editable.UPDATE, false, 30, 5);
...
const BAHNVERWALTUNG = new DropDownColumn('Bahnverwaltung', 'bahnverwaltung', (entity) => { return entity.bahnverwaltung ? entity.bahnverwaltung.name : undefined; }, (entity, value) => { entity.bahnverwalung = { name: value }; }, BAHNVERWALTUNG_DROP, Editable.UPDATE, false, 30, 5);
...
const DECODER = new DropDownColumn('Decoder', 'decoder', (entity) => { return entity.decoder ? entity.decoder.decoderId : undefined; }, (entity, value) => { entity.decoder = { decoderId: value }; }, DECODER_DROP, Editable.UPDATE, false, 30, 5);
...
const DECODER_TYP = new DropDownColumn('Decoder Typ', 'decoderTyp', (entity) => { return entity.decoderTyp ? extractProduktValue(entity.decoderTyp) : undefined; }, (entity, value) => { let parts = value.split('/'); entity.decoderTyp = { hersteller: { name: parts[0] }, bestellNr: parts[1] }; }, DECODER_TYP_DROP, Editable.UPDATE, false, 50, 5);
...
const EPOCH = new DropDownColumn('Epoch', 'epoch', (entity) => { return entity.epoch ? entity.epoch.name : undefined; }, (entity, value) => { entity.epoch = { name: value }; }, EPOCH_DROP, Editable.UPDATE, false, 30, 5);
...
const GATTUNG = new DropDownColumn('Gattung', 'gattung', (entity) => { return entity.gattung ? entity.gattung.name : undefined; }, (entity, value) => { entity.gattung = { name: value }; }, GATTUNG_DROP, Editable.UPDATE, false, 30, 5);
...
const KUPPLUNG = new DropDownColumn('Kupplung', 'kupplung', (entity) => { return entity.kupplung ? entity.kupplung.name : undefined; }, (entity, value) => { entity.kupplung = { name: value }; }, KUPPLUNG_DROP, Editable.UPDATE, false, 30, 5);
...
const LICHT = new DropDownColumn('Licht', 'licht', (entity) => { return entity.licht ? entity.licht.name : undefined; }, (entity, value) => { entity.licht = value; }, LICHT_DROP, Editable.UPDATE, false, 30, 5);
const MASSSTAB = new DropDownColumn('Maßstab', 'massstab', (entity) => { return entity.massstab ? entity.massstab : undefined; }, (entity, value) => { entity.massstab = { name: value }; }, MASSSTAB_DROP, Editable.UPDATE, false, 30, 5);
...
const MOTOR_TYP = new DropDownColumn('MotorTyp', 'motorTyp', (entity) => { return entity.motorTyp ? entity.motorTyp.name : undefined; }, (entity, value) => { entity.motorTyp = { name: value }; }, MOTOR_TYP_DROP, Editable.UPDATE, false, 30, 5);
...
const PRODUKT = new DropDownColumn('Produkt', 'produkt', (entity) => { return entity.produkt ? extractProduktValue(entity.produkt) : undefined; }, (entity, value) => { let parts = value.split('/'); entity.produkt = { hersteller: { name: parts[0] }, bestellNr: parts[1] }; }, PRODUKT_DROP, Editable.UPDATE, false, 50, 5);
...
const SONDERMODELL = new DropDownColumn('Sonder Modell', 'sonderModell', (entity) => { return entity.sonderModell ? entity.sonderModell.name : undefined; }, (entity, value) => { entity.sonderModell = { name: value }; }, SONDERMODELL_DROP, Editable.UPDATE, false, 30, 5);
const SPAN = new NumberColumn('Span', 'span', (entity) => { return entity.span; }, (entity, value) => { entity.span = value; }, Editable.UPDATE, true, 16, 1);
const SPURWEITE = new DropDownColumn('Spurweite', 'spurweite', (entity) => { return entity.spurweite ? entity.spurweite.name : undefined; }, (entity, value) => { entity.spurweite = { name: value }; }, SPURWEITE_DROP, Editable.UPDATE, false, 30, 5);
const STATUS = new DropDownColumn('Status', 'status', (entity) => { return entity.status; }, (entity, value) => { entity.status = value; }, STATUS_DROP, Editable.UPDATE, false, 30, 5);
const STECKER = new DropDownColumn('Stecker', 'stecker', (entity) => { return entity.stecker; }, (entity, value) => { entity.stecker = value; }, STECKER_DROP, Editable.UPDATE, false, 30, 5);
const STEUERUNG = new DropDownColumn('Steuerung', 'steuerung', (entity) => { return entity.steuerung ? entity.steuerung.name : undefined; }, (entity, value) => { entity.steuerung = { name: value }; }, STEUERUNG_DROP, Editable.UPDATE, false, 30, 5);
...
const TEIL = new DropDownColumn('Teil', 'teil', (entity) => { return entity.teil ? extractProduktValue(entity.teil) : undefined; }, (entity, value) => { let parts = value.split('/'); entity.teil = { hersteller: { name: parts[0] }, bestellNr: parts[1] }; }, PRODUKT_DROP, Editable.UPDATE, false, 50, 5);
...
const VORBILD = new DropDownColumn('Vorbild', 'vorbild', (entity) => { return entity.vorbild ? entity.vorbild.gattung.name : undefined; }, (entity, value) => { entity.vorbild = { gattung: { name: value } }; }, VORBILD_DROP, Editable.UPDATE, false, 30, 5);
const WAHRUNG = new DropDownColumn('Wahrung', 'wahrung', (entity) => { return entity.wahrung ? entity.wahrung.name : undefined; }, (entity, value) => { entity.wahrung = { name: value }; }, WAHRUNG_DROP, Editable.UPDATE, false, 30, 5);
...
const ZUG_TYP = new DropDownColumn('Typ', 'typ', (entity) => { return entity.zugTyp.name; }, (entity, value) => { entity.zugTyp = { name: value }; }, ZUG_TYP_DROP, Editable.UPDATE, false, 30, 5);
