...
const AUSSERDIENST = new NumberColumn("Außerdienst", "ausserdienst", (entity) => { return entity.ausserdienst; }, (entity, value) => { entity.ausserdienst = value; }, Editable.UPDATE, false, 2100, 1800);
...
const KAPAZITAT = new NumberColumn("Kapazität", "kapazitat", (entity) => { return entity.kapazitat; }, (entity, value) => { entity.kapazitat = value; }, Editable.UPDATE, false, 3000, 1, .01);
...
const KESSELUBERDRUCK = new NumberColumn("Kesselüberdruck", "kesseluberdruck", (entity) => { return entity.kesseluberdruck; }, (entity, value) => { entity.kesseluberdruck = value; }, Editable.UPDATE, false, 3000, 0, .01);
...
const LANGE = new NumberColumn("Länge", "lange", (entity) => { return entity.lange; }, (entity, value) => { entity.lange = value; }, Editable.UPDATE, false, 50, 1, .01);
...
const LEISTUNGSUBERTRAGUNG = new NumberColumn("Leistungsübertragung", "leistungsubertragung", (entity) => { return entity.leistungsubertragung; }, (entity, value) => { entity.leistungsubertragung = value; }, Editable.UPDATE, false, 10000, 0, .01);
...
const MASSSTAB = new SelectColumn("Maßstab", "massstab", (entity) => { return entity.massstab ? entity.massstab.name : undefined; }, (entity, value) => { entity.massstab = value; }, MASSSTAB_DROP, Editable.UPDATE, false);
...
const ROSTFLACHE = new NumberColumn("Rostfläche", "rostflache", (entity) => { return entity.rostflache; }, (entity, value) => { entity.rostflache = value; }, Editable.UPDATE, false, 3000, 0, .01);
...
const UBERHITZERFLACHE = new NumberColumn("Überhitzerfläche", "uberhitzerflache", (entity) => { return entity.uberhitzerflache; }, (entity, value) => { entity.uberhitzerflache = value; }, Editable.UPDATE, false, 3000, 0, .01);
