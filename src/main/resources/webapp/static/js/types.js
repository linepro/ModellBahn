...
const extractBezeichnung = (entity) => { return entity.bezeichnung; };
...
const AUFBAU_DROP = new DropDown(apiRoot() + "aufbau", [[extractName, extractBezeichnung]], extractImage);
...
const KUPPLUNG_DROP = new DropDown(apiRoot() + "kupplung", [[extractName, extractBezeichnung]], extractImage);
const LAND_DROP = new DropDown(apiRoot() + "land", [[extractName, extractBezeichnung]]);
const LICHT_DROP = new DropDown(apiRoot() + "licht", [[extractName, extractBezeichnung]], extractImage);
...
const UNTER_KATEGORIE_DROP = new DropDown(apiRoot() + "kategorie", [[extractName, extractBezeichnung], [extractUnterKategorien, extractName]]);
