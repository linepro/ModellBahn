...
const LICHT_DROP = new DropDown(apiRoot() + "licht", extractName, extractName, extractName);
...
const UNTER_KATEGORIE_DROP = new DropDown(apiRoot() + "kategorie", extractUnterKategorien, extractName);
