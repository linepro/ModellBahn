...
const VORBILD_DROP = new DropDown(apiRoot() + "vorbild", (entity) => { entity.gattung; }, (entity) => { return new Option(entity.gattung, entity.gattung); });
...
const AUSSERDIENST = new NumberColumn("Ausserdienst", "ausserdienst", (entity) => { return entity.ausserdienst; }, (entity, value) => { entity.ausserdienst = value; }, Editable.UPDATE, false, 2100, 1800);
...
const BAUZEIT = new NumberColumn("Bauzeit", "bauzeit", (entity) => { return entity.bauzeit; }, (entity, value) => { entity.bauzeit = value; }, Editable.UPDATE, false, 2100, 1800);
...
const BESTELL_NR = new TextColumn("Bestell Nr", "beste	llNr", (entity) => { return entity.bestellNr; }, (entity, value) => { entity.bestellNr = value; }, Editable.ADD, true, 10);
...
const GERAUSCH = new BoolColumn("Gerausch", "gerausch", (entity) => { return entity.sound; }, (entity, value) => { entity.sound = value; }, Editable.UPDATE, true);
...
const KAPAZITAT = new NumberColumn("Kapazitat", "kapazitat", (entity) => { return entity.kapazitat; }, (entity, value) => { entity.kapazitat = value; }, Editable.UPDATE, false, 3000, 1, .01);
...
const KESSELUEBERDRUCK = new NumberColumn("Kesselueberdruck", "kesselueberdruck", (entity) => { return entity.kesselueberdruck; }, (entity, value) => { entity.kesselueberdruck = value; }, Editable.UPDATE, false, 3000, 0, .01);
...
const KOLBENHUB = new NumberColumn("Kolbenhub", "kolbenhub", (entity) => { return entity.kolbenhub; }, (entity, value) => { entity.kolbenhub = value; }, Editable.UPDATE, false, 3000, 1, .01);
...
const LANGE = new NumberColumn("Lange", "lange", (entity) => { return entity.lange; }, (entity, value) => { entity.lange = value; }, Editable.UPDATE, false, 50, 1, .01);
const LEISTUNG = new NumberColumn("Leistung", "leistung", (entity) => { return entity.leistung; }, (entity, value) => { entity.leistung = value; }, Editable.UPDATE, false, 10000, 0, .01);
const LEISTUNGSUEBERTRAGUNG = new NumberColumn("Leistungsuebertragung", "leistungsuebertragung", (entity) => { return entity.leistungsuebertragung; }, (entity, value) => { entity.leistungsuebertragung = value; }, Editable.UPDATE, false, 10000, 0, .01);
...
const MASSSTAB = new SelectColumn("Massstab", "massstab", (entity) => { return entity.massstab ? entity.massstab.name : undefined; }, (entity, value) => { entity.massstab = value; }, MASSSTAB_DROP, Editable.UPDATE, false);
...
const PREIS = new NumberColumn("Preis", "preis", (entity) => { return entity.preis; }, (entity, value) => { entity.preis = value; }, Editable.UPDATE, false, undefined, 0, .01);
...
const ROSTFLAECHE = new NumberColumn("Rostflaeche", "rostflaeche", (entity) => { return entity.rostflaeche; }, (entity, value) => { entity.rostflaeche = value; }, Editable.UPDATE, false, 3000, 0, .01);
...
const SONDERMODELL = new SelectColumn("Sondermodell", "sonderModell", (entity) => { return entity.sondermodell ? entity.sondermodell.name : undefined; }, (entity, value) => { entity.sondermodell = value; }, SONDERMODELL_DROP, Editable.UPDATE, false);
...
const STUCK = new NumberColumn("Stuck", "stuck", (entity) => { return entity.stuck; }, (entity, value) => { entity.stuck = value; }, Editable.UPDATE, false, 300, 0);
...
const TRIEBKOEPFE = new NumberColumn("Triebkoepfe", "triebkoepfe", (entity) => { return entity.triebkoepfe; }, (entity, value) => { entity.triebkoepfe = value; }, Editable.UPDATE, false, 2, 0);
const UEBERHITZERFLAECHE = new NumberColumn("Ueberhitzerflaeche", "ueberhitzerflaeche", (entity) => { return entity.ueberhitzerflaeche; }, (entity, value) => { entity.ueberhitzerflaeche = value; }, Editable.UPDATE, false, 3000, 0, .01);
...
const VERDAMPFUNG = new NumberColumn("Verdampfung", "verdampfung", (entity) => { return entity.verdampfung; }, (entity, value) => { entity.verdampfung = value; }, Editable.UPDATE, false, 3000, 0, .01);
const VORBILD = new SelectColumn("Vorbild", "vorbild", (entity) => { return entity.vorbild ? entity.vorbild.gattung : undefined; }, (entity, value) => { entity.vorbild = value; }, VORBILD_DROP, Editable.UPDATE, false);
...
const WASSERVORRAT = new NumberColumn("Wasservorrat", "wasservorrat", (entity) => { return entity.wasservorrat; }, (entity, value) => { entity.wasservorrat = value; }, Editable.UPDATE, false, 3000, 0, .01);
