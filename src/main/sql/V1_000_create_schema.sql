...
create table anderung (id bigint not null, deleted boolean not null, anderungId integer not null check (anderungId>=1), anderungsdatum date, anderungsTyp varchar(255) not null, anmerkung varchar(255), bezeichnung varchar(100), stuck integer, artikel_id bigint not null, primary key (id))
...
create index IDXavaix6w1r0wwq6imquqyl6sah on anderung (anderungId)
alter table anderung add constraint UK6r7gjbvubq5ht1c7a2ojuryxf unique (artikel_id, anderungId)
